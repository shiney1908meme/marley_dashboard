      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#1C2526] border-2 border-[#6B21A8]/30 rounded-xl p-1 transition-all duration-300 group-hover:border-[#6B21A8] group-focus-within:border-[#22C55E]">
